...
namespace MetricsAgentTests
{
    public class NetworkMetricsTests
    {
        ...
        {
            repositoryMock.Setup(repositoryMock => repositoryMock.GetByTimePeriod(It.IsAny<TimeSpan>(), It.IsAny<TimeSpan>())).Returns(new List<NetworkMetricDto>() { new NetworkMetricDto() });
